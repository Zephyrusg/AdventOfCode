...
namespace AdventOfCode._2022
{
    ...
    { 
        ...
        static List<int> ElfsCalories = new List<int>();
        public static int Part1() {
            
            int answer = 0;
            string Data = File.ReadAllText(Path);
            string[]DataList = Data.Split(new string[] { Environment.NewLine + Environment.NewLine }, StringSplitOptions.RemoveEmptyEntries);
